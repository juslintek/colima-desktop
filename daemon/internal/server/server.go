...
// Register registers the ColimaService with a gRPC server.
func Register(s *grpc.Server) {
	s.RegisterService(&_ColimaService_serviceDesc, New())
}

// Service descriptor (minimal stub — in production, generated by protoc)
var _ColimaService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "colimaui.ColimaService",
	HandlerType: (*pb.ColimaServiceServer)(nil),
...
func (s *ColimaServer) KubeExec(_ context.Context, req *pb.KubeExecRequest) (*pb.KubeExecResponse, error) {
